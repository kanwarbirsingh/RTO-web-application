...
public partial class Admin_Entryadmin : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.Add("@adid", SqlDbType.Int).Value = Convert.ToInt32(txt1.Text);
        ...
        cmd.Parameters.Add("@sque", SqlDbType.VarChar, 50).Value = DropDownList1.Text;
