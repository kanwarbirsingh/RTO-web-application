...
public partial class Forms_Medical_Formcfa : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("insert_cfaapplication", con);
        ...
        cmd.Parameters.Add("@a10", SqlDbType.VarChar, 50).Value = TextBox4.Text;
