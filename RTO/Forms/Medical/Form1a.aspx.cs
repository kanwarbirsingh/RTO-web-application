...
public partial class Forms_Medical_Form1a : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("insert_medicalcertificate", con);
        ...
        cmd.Parameters.Add("@a14", SqlDbType.Date).Value = TextBox14.Text;
        cmd.ExecuteNonQuery();
        con.Close();
        clr();
    }
